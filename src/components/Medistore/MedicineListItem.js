  ...
  return (
    <div className={`card ${isExpired ? 'expired' : ''}`}>
      <div className={`card-body ${isExpired ? 'expired' : ''}`}>
        ...
        <Link to={`/Medistore/data/${props.medicine.id}/edit`} className="btn btn-warning float-right">
          Edit
        </Link>

        <Link to={`/Medistore/data/${props.medicine.id}`} className="btn btn-success float-right">
          View
        </Link>
      </div>
        ...
        <div className="modal-dialog" role="document">
          <div className="modal-content">
            ...
            <div className="modal-footer">
              ...
              <button type="button" className="btn btn-Dark" onClick={handleCloseDeleteConfirmation}>
                Cancel
              </button>
            </div>
          </div>
